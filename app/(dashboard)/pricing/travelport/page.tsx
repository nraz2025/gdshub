...
const D = {
  ...
  accent: '#58a6ff', accentSoft: 'rgba(88,166,255,0.10)', titleColor: '#b8dcff',
...
export default function PricingTravelportPage() {
      ...
      <div style={{padding:'32px 28px 40px'}}>
        ...
        <div style={{display:'flex', alignItems:'flex-start', justifyContent:'space-between', flexWrap:'wrap', gap:'16px', marginBottom:'22px'}}>
          <div>
            <h1 style={{fontFamily:"'Space Grotesk', sans-serif", fontSize:'26px', fontWeight:700, letterSpacing:'-0.5px', color:D.fg, margin:0}}>
              <span style={{display:'inline-flex', alignItems:'center', fontSize:'15px', fontWeight:700, color:D.accent, background:D.accentSoft, border:`1px solid ${D.accent}40`, borderRadius:'8px', padding:'5px 12px', marginRight:'10px', verticalAlign:'middle'}}>Travelport</span>
              Pricing
            </h1>
        ...
        {loading ? (
          ...
          <div style={{background:D.card, border:`1px solid ${D.border}`, borderRadius:'10px', padding:'48px', textAlign:'center', color:D.fgDim, fontSize:'15px'}}>
            {records.length === 0 ? 'No pricing items yet. Add the first Travelport pricing item to get started.' : 'No pricing items match your search or filter.'}
          </div>
        ) : (
