    ...
    <div style={{fontFamily:'Inter, system-ui, sans-serif', background:'#f1f5f9', minHeight:'100vh'}}>
      <div style={{padding:'20px 28px',marginBottom:'0'}}>
        <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',flexWrap:'wrap',gap:'12px'}}>
          <div>
            <h1 style={{fontSize:'24px',fontWeight:700,color:'#1e293b',margin:0,letterSpacing:'-0.02em'}}>Travelport Users</h1>
            <p style={{fontSize:'14px',color:'#64748b',marginTop:'4px'}}>Manage Travelport CID and GTID accounts</p>
          </div>
          {isAdmin && (
      ...
      <div style={{padding:'0 28px 28px'}}>
        ...
        <div style={{display:'flex', alignItems:'center', marginBottom:'16px'}}>
          <span style={{fontSize:'14px', color:'#64748b'}}>Showing <strong style={{color:'#1e293b'}}>{filtered.length} Travelport user{filtered.length!==1?'s':''}</strong></span>
        </div>
