...
const nav: NavItem[] = [
  ...
  {
    label: 'GDS Functionality',
    href: '/gds-functionality',
  ...
  {
    label: 'GDS Information',
    href: '/gds-information',
  ...
  },
  {
    ...
    href: '/travelport-users',
    icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 1 0-16 0"/></svg>
  },
  {
    label: 'GDS Assignments',
    href: '/gds-assigned',
    icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
  },
  {
...
export default function Sidebar({ isAdmin }: { isAdmin: boolean }) {
  ...
  return (
    <aside className="w-60 bg-slate-900 flex flex-col h-full flex-shrink-0">
      {/* Brand */}
      <div className="flex items-center gap-3 px-5 py-5 border-b border-slate-800">
        ...
        <div>
          <p className="text-white font-semibold text-sm leading-tight">GDSHub</p>
          <p className="text-slate-500 text-xs">PST Travel</p>
        </div>
      </div>
