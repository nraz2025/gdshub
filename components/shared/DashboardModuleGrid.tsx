...
const GROUPS: { title: string; color: string; soft: string; keys: string[] }[] = [
  ...
  { title: 'Pricing',      color: '#d29922', soft: 'rgba(210,153,34,0.10)', keys: ['pricing'] },
  { title: 'System',       color: '#f78166', soft: 'rgba(247,129,102,0.10)', keys: ['organisation', 'users', 'gds', 'client', 'reporting', 'contract', 'admin_panel'] },
]
